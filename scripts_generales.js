...
(function () {
  ...
  modal.hidden = true;
  modal.innerHTML = `
    <button class="modal-perfil-fondo" type="button" data-cerrar-perfil aria-label="Cerrar perfil"></button>
    <section class="modal-perfil-contenido" role="dialog" aria-modal="true" aria-labelledby="tituloPerfilUsuario">
      <header class="modal-perfil-cabecera">
  ...
  const alternarPerfil = function (abrir) {
    modal.hidden = !abrir;
    document.body.classList.toggle('perfil-abierto', abrir);
